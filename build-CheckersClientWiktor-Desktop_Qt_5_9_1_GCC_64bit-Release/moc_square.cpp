...
#include "../CheckersClientWiktor/square.h"
...
QT_MOC_LITERAL(1, 7, 22), // "squareClickedWithMouse"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 7), // "Square*"
QT_MOC_LITERAL(4, 39, 4) // "that"

    },
    "Square\0squareClickedWithMouse\0\0Square*\0"
    "that"
};
...
void Square::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->squareClickedWithMouse((*reinterpret_cast< Square*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Square::*_t)(Square * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Square::squareClickedWithMouse)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Square::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Square.data,
...
// SIGNAL 0
void Square::squareClickedWithMouse(Square * _t1)
{

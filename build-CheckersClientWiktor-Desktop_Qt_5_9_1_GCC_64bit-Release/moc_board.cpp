...
#include "../CheckersClientWiktor/board.h"
...
QT_MOC_LITERAL(1, 6, 28), // "squareClickedWithMouseSignal"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 7), // "Square*"
QT_MOC_LITERAL(4, 44, 4), // "that"
QT_MOC_LITERAL(5, 49, 22) // "squareClickedWithMouse"

    },
    "Board\0squareClickedWithMouseSignal\0\0"
    "Square*\0that\0squareClickedWithMouse"
};
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->squareClickedWithMouseSignal((*reinterpret_cast< Square*(*)>(_a[1]))); break;
        case 1: _t->squareClickedWithMouse((*reinterpret_cast< Square*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Board::*_t)(Square * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::squareClickedWithMouseSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Board::squareClickedWithMouseSignal(Square * _t1)
{

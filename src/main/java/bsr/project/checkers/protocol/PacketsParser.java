...
public class PacketsParser {
	...
	public ProtocolPacket parsePacket(String packet, ServerData serverData, ClientData clientData) throws ParseException {
		...
		switch (code) {
			...
			case "RP1": { // 5. Pytanie o grę - przekazanie prośby o rozpoczęcie nowej gry
